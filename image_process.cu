...
Output: None
*/
void phase_correlation(device_vector<float>& input1, device_vector<float>& input2, int row, int col, float& x_shift, float& y_shift)
{
	...
	cufftPlan2d(&plan1, row, col, CUFFT_R2C);
	//fft
...
int main()
{
	...
	phase_correlation(image1, image2, a.height, a.width,x,y);
